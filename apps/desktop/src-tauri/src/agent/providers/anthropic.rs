...
impl AnthropicProvider {
    ...
    async fn raw_models(&self) -> Result<Vec<AgentModelOption>, AgentError> {
        let value = self
            .core
            .get_json(&self.core.url("v1/models"), self.headers())
            .await?;
...
impl AgentProvider for AnthropicProvider {
    ...
    async fn run(
        ...
        let value = self
            .core
            .post_json(&self.core.url("v1/messages"), self.headers(), body)
            .await?;
            ...
            Some("tool_use") => {
                let call = ProviderToolCall {
                    ...
                    name: block
                        ...
                        .into(),
                    arguments: block.get("input").cloned().ok_or_else(|| {
