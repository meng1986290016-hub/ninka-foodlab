...
describe("BrowserDemoApi", () => {
  ...
  it("migrates a flat v1 record without losing supplier data", async () => {
    ...
    expect(storage.getItem("food-rd.browser-demo.v5")).not.toBeNull();
